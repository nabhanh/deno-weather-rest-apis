...
export namespace Prisma {
  ...
  */
  ...
  export class Prisma__CityClient<T, Null = never> implements PrismaPromise<T> {
    ...
    Weather<T extends WeatherFindManyArgs= {}>(args?: Subset<T, WeatherFindManyArgs>): PrismaPromise<Array<WeatherGetPayload<T>>| Null>;
  ...
  export type WeatherGetPayload<S extends boolean | null | undefined | WeatherArgs> =
    ...
    : S extends { select: any } & (WeatherArgs | WeatherFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'city' ? CityGetPayload<S['select'][P]> :  P extends keyof Weather ? Weather[P] : never
  } 
      : Weather
  ...
  export interface WeatherDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    >(args: SubsetIntersection<T, WeatherGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetWeatherGroupByPayload<T> : PrismaPromise<InputErrors>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__WeatherClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
  ...
  export type WeatherCreateNestedManyWithoutCityInput = {
    create?: XOR<Enumerable<WeatherCreateWithoutCityInput>, Enumerable<WeatherUncheckedCreateWithoutCityInput>>
  ...
  export type WeatherUpdateManyWithWhereWithoutCityInput = {
    ...
    data: XOR<WeatherUpdateManyMutationInput, WeatherUncheckedUpdateManyWithoutWeatherInput>
  }
